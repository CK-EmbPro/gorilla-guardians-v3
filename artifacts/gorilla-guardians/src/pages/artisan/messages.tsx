...
const demoConvs = [
  { id: 1, otherUser: { name: "Sarah Johnson", role: "customer" }, lastMessage: "When will my order ship?", unreadCount: 2, updatedAt: new Date(Date.now() - 30 * 60 * 1000).toISOString() },
  { id: 2, otherUser: { name: "Admin Team", role: "admin" }, lastMessage: "Your payment has been processed.", unreadCount: 0, updatedAt: new Date(Date.now() - 2 * 3600 * 1000).toISOString() },
];
